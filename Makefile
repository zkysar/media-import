...
BIN_LINK := $(HOME)/.local/bin/dji-import
COMP_LINK := $(HOME)/.zsh/completions/_dji-import

.PHONY: install uninstall test help

help:
	@echo "Targets:"
	@echo "  install    symlink dji-import + completion into PATH/fpath"
...
install:
	...
	@ln -sf $(PROJECT_DIR)/dji-import $(BIN_LINK)
	@ln -sf $(PROJECT_DIR)/completions/_dji-import $(COMP_LINK)
	@echo "linked: $(BIN_LINK) -> $(PROJECT_DIR)/dji-import"
	@echo "linked: $(COMP_LINK) -> $(PROJECT_DIR)/completions/_dji-import"
